    ...
    this.formInputDiseases = this.createElement(
      `<div class="forms-inputs mb-4">
            <input class="forms-inputs__item diseases-input"
              placeholder="Перенесені захворювання"
              autocomplete="off"
              type="text"
            />
          </div>`
  ...
  checkValueAge() {
    ...
    this.inValidAge = this.createElement(
      `<div class="invalid-age-box">
          <p class="invalid-age-box__text">Введіть коректний вік</p>
            </div>`
    );
  ...
  checkValuePressure() {
    ...
    this.inValidPressure = this.createElement(
      `<div class="invalid-pressure-box">
          <p class="invalid-pressure-box__text">Введіть тиск у числовому форматі в діапазоні від 50 до 160</p>
            </div>`
    );
